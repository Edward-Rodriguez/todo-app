...
`, "",{"version":3,"sources":["webpack://./src/components/todoItem/todoItem.css"],"names":[],"mappings":"AAAA;EACE,aAAa;EACb,eAAe;EACf,mBAAmB;EACnB,SAAS;EACT,sBAAsB;EACtB,kBAAkB;AACpB;AACA;EACE,WAAW;EACX,aAAa;EACb,kEAAkE;EAClE;;;mCAGiC;EACjC,+BAA+B;EAC/B,8BAA8B;AAChC;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,mBAAmB;AACrB;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,oBAAoB;AACtB;;AAEA;EACE,eAAe;EACf,YAAY;EACZ,gBAAgB;EAChB,yBAAyB;AAC3B","sourcesContent":[".todo-container {\n  display: flex;\n  flex-wrap: wrap;\n  align-items: center;\n  gap: 12px;\n  border: 2px solid grey;\n  border-radius: 8px;\n}\n.dropdown {\n  width: 100%;\n  display: grid;\n  grid-template: min-content auto auto/ min-content auto min-content;\n  grid-template-areas:\n    'project priority edit'\n    'notes notes notes'\n    'checklist checklist checklist';\n  border-top: 1px solid lightgrey;\n  justify-content: space-between;\n}\n\n.project {\n  grid-area: project;\n}\n\n.priority {\n  grid-area: priority;\n}\n\n.dropdown img {\n  grid-area: edit;\n}\n\n.notes {\n  grid-area: notes;\n}\n\n.checklist {\n  grid-area: checklist;\n}\n\n.todo-container button {\n  cursor: pointer;\n  border: none;\n  appearance: none;\n  background-color: inherit;\n}\n"],"sourceRoot":""}]);
// Exports
...
`, "",{"version":3,"sources":["webpack://./src/index.css"],"names":[],"mappings":"AAEA;EACE,sBAAsB;EACtB,iCAAiC;AACnC;;AAEA;;;EAGE,mBAAmB;EACnB,SAAS;EACT,UAAU;AACZ","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Roboto&display=swap');\n\nhtml {\n  box-sizing: border-box;\n  font-family: 'Roboto', sans-serif;\n}\n\n*,\n*::before,\n*::after {\n  box-sizing: inherit;\n  margin: 0;\n  padding: 0;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
